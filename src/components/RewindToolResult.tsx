    ...
    return (
        <>
            ...
            <div className="mt-4 grid grid-cols-1 gap-3 md:grid-cols-3">
                <Metric label="Shares" value={result.shares} hint={`@ ${result.entry.close} / share`} />
                <Metric label="Return" value={result.pnlAmount} hint={`${result.returnPct}`} />
                <Metric label="Final Value" value={result.netProceeds} hint={`@ ${result.exit.close} / share`} />
            </div>
        </>
    )
}
