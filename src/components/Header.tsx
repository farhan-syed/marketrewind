    ...
    <header className="sticky top-0 z-30 border-b border-zinc-800/80 bg-zinc-950/80 backdrop-blur">
      <div className="mx-auto max-w-6xl px-4 py-4 flex items-center justify-between">
        <a href="/" className="inline-flex items-center gap-1">
          ...
          <RewindIcon size={24} strokeWidth={3} />
        </a>
        ...
        <div className="flex items-center gap-3">
          <a href="/signin" className="text-md opacity-80 hover:opacity-100">Sign in</a>
          <a href="/signup" className="rounded-lg bg-zinc-100 px-3 py-1.5 text-md font-medium text-zinc-900 hover:bg-white">Create account</a>
        </div>
      </div>
    </header>
